 ...
 */
package gov.nist.healthcare.tools.hl7.v2.xtcamt.lite.service.util;

/**
 * @author Harold Affo (harold.affo@nist.gov) Apr 15, 2015
 */
public class TestPlanPropertySaveError extends AbscractPropertySaveError {
	/**
	 * @param targetId
	 * @param fieldName
	 * @param targetType
	 ...
	 * @param command
	 */
	public TestPlanPropertySaveError(String targetId, String targetType,
	...
	public String toString() {
		return "TestPlanPropertySaveError [targetId=" + this.getTargetId()
